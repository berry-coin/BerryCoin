...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars BERRYCOIND and BERRYCOINCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

BITCOIND=${BERRYCOIND:-${1}/berrycoind}
CLI=${BERRYCOINCLI:-${1}/berrycoin-cli}
