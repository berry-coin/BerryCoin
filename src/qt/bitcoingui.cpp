...
// Copyright (c) 2016 The BerryCoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BerryCoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // BerryCoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // BerryCoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // BerryCoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BerryCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BerryCoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About BerryCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BerryCoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for BerryCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BerryCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BerryCoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BerryCoin Core help message to get a list with possible BerryCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BerryCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BerryCoin network", "", count));
}
...
{
    QString strTitle = tr("BerryCoin"); // default title
